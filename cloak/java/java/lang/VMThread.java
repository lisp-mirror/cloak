/*
 * Taken from classpath/vm/reference/java/lang/VMThread.java rev 1.1:
 *   - added vmData* fields
 */
...
final class VMThread
{
     ...
     * Lisp-Thread
     */
    private volatile Object vmData;
    private volatile Object vmDataInterrupted;
    private volatile Object vmDataIndex;
